...
import com.example.final_cuetify.adapters.ChatAdapter;
import com.example.final_cuetify.databinding.ActivityChatBinding;
import com.example.final_cuetify.models.ChatMessage;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private void sendMessages() {
        ...
        message.put(Constants.KEY_UNI_ID, preferenceManager.getString(Constants.KEY_UNI_ID));
        message.put(Constants.KEY_PHONE,preferenceManager.getString(Constants.KEY_PHONE));
    ...
    private void updateConversion(String message) {
        DocumentReference documentReference =
                database.collection(Constants.KEY_CONVERSATIONS).document(conversionId);
