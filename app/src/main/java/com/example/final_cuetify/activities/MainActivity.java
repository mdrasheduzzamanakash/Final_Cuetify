...
import com.example.final_cuetify.adapters.RecentConversionAdapter;
import com.example.final_cuetify.databinding.ActivityMainBinding;
import com.example.final_cuetify.listener.ConversionListener;
...
public class MainActivity extends AppCompatActivity implements ConversionListener , View.OnClickListener{
    ...
    private void init() {
        ...
        binding.conversationalRecyclerView.setAdapter(conversionAdapter);
